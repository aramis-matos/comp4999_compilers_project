...
#undef YYCASE_
  ...
  "\"identificador\"", "\"fin_de_linea\"", "\"enlace\"", "\"digito\"",
  "\"valencia\"", "$accept", "unit", "exps", "exp", YY_NULLPTR
  };
#endif

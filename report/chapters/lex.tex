...
Estos devuelven, respectivamente, el tipo, lexema, en que línea del archivo se encuentra y la posición del primer caracter de el \textit{token} llamado \text{tok}. 

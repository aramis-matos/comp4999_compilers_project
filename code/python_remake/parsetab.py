...
_lr_productions = [
  ...
  ('modelo_molecular -> ELEMENTO_QUIMICO','modelo_molecular',1,'p_modelo_molecular','parser.py',35),
  ('modelo_molecular -> ELEMENTO_QUIMICO VALENCIA','modelo_molecular',2,'p_modelo_molecular','parser.py',36),
  ('modelo_molecular -> elemento grupo_funcional','modelo_molecular',2,'p_modelo_molecular','parser.py',37),
  ('modelo_molecular -> compuesto elemento','modelo_molecular',2,'p_modelo_molecular','parser.py',38),
  ('modelo_molecular -> compuesto elemento grupo_funcional','modelo_molecular',3,'p_modelo_molecular','parser.py',39),
  ('modelo_molecular -> compuesto compuesto compuestos','modelo_molecular',3,'p_modelo_molecular','parser.py',40),
  ('compuesto -> ELEMENTO_QUIMICO','compuesto',1,'p_compuesto','parser.py',45),
  ('compuesto -> ELEMENTO_QUIMICO VALENCIA','compuesto',2,'p_compuesto','parser.py',46),
  ('compuesto -> elemento grupo_funcional','compuesto',2,'p_compuesto','parser.py',47),
  ('compuesto -> elemento grupo_funcional ENLACE','compuesto',3,'p_compuesto','parser.py',48),
  ('compuesto -> elemento ENLACE','compuesto',2,'p_compuesto','parser.py',49),
  ('compuestos -> compuesto compuestos','compuestos',2,'p_compuestos','parser.py',54),
  ('compuestos -> compuesto','compuestos',1,'p_compuestos','parser.py',55),
  ('elemento -> ELEMENTO_QUIMICO','elemento',1,'p_elemento','parser.py',60),
  ('elemento -> ELEMENTO_QUIMICO VALENCIA','elemento',2,'p_elemento','parser.py',61),
  ('grupo_funcional -> grupo_funcional_inferior grupo_funcional_superior','grupo_funcional',2,'p_grupo_funcional','parser.py',66),
  ('grupo_funcional -> grupo_funcional_superior grupo_funcional_inferior','grupo_funcional',2,'p_grupo_funcional','parser.py',67),
  ('grupo_funcional -> PARENTESIS_IZQ modelo_grupo_funcional PARENTESIS_DER','grupo_funcional',3,'p_grupo_funcional','parser.py',68),
  ('grupo_funcional -> COR_IZQ modelo_grupo_funcional COR_DER','grupo_funcional',3,'p_grupo_funcional','parser.py',69),
  ('grupo_funcional_inferior -> COR_IZQ modelo_grupo_funcional COR_DER','grupo_funcional_inferior',3,'p_grupo_funcional_inferior','parser.py',74),
  ('grupo_funcional_superior -> PARENTESIS_IZQ modelo_grupo_funcional PARENTESIS_DER','grupo_funcional_superior',3,'p_grupo_funcional_superior','parser.py',79),
  ('modelo_grupo_funcional -> ENLACE modelo_molecular','modelo_grupo_funcional',2,'p_modelo_grupo_funcional','parser.py',84),
  ('modelo_grupo_funcional -> ELEMENTO_QUIMICO','modelo_grupo_funcional',1,'p_modelo_grupo_funcional','parser.py',85),
  ('modelo_grupo_funcional -> ELEMENTO_QUIMICO VALENCIA','modelo_grupo_funcional',2,'p_modelo_grupo_funcional','parser.py',86),
  ('modelo_grupo_funcional -> elemento grupo_funcional','modelo_grupo_funcional',2,'p_modelo_grupo_funcional','parser.py',87),
  ('modelo_grupo_funcional -> compuesto elemento','modelo_grupo_funcional',2,'p_modelo_grupo_funcional','parser.py',88),
  ('modelo_grupo_funcional -> compuesto elemento grupo_funcional','modelo_grupo_funcional',3,'p_modelo_grupo_funcional','parser.py',89),
  ('modelo_grupo_funcional -> compuesto compuesto compuestos','modelo_grupo_funcional',3,'p_modelo_grupo_funcional','parser.py',90),
]
